...
class SouscriptionEpargnant extends StatefulWidget {
  const SouscriptionEpargnant({Key? key}) : super(key: key);
  static const routeName = '/souscription-epargnant';

  @override
  State<SouscriptionEpargnant> createState() => _SouscriptionEpargnantState();
}

class _SouscriptionEpargnantState extends State<SouscriptionEpargnant> {
...
// ...
  ...
  Future<void> CreerSouscriptionEpargnant() async {
    int bankId = int.parse(bankController.text);
    String? token = await getToken();
